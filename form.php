  ...
  <div>
		<h2>Contacts Us</h2>
			<?php
				...
				$nameErr = $emailErr = $messageErr = $mlenErr = $nlenErr = "";
				$name = $email =$message = "";
				$submitted = 0;
                ...
                {
					$nlenErr = "**name is too long, maximum is 100 characters";
					echo $nlenErr;
                }
			}
                 ...
                 if (strlen($message) > MAX_MESSAGE_LENGTH)
                  ...
                  $mlenErr = "**message is too long, maximum is 255 characters";
				  echo $mlenErr;
                  } 
			}
		...
		?>
			<div>
				...
				<form name="contactus" method="post" action="form.php">
			<div>
...
<?php    
            ...
            if (isset($fill)) {
			if (empty($nameErr) && empty($emailErr) && empty($nlenErr) && empty($mlenErr)) {

				$date = date("F d, Y h:m A");
				$ip = $_SERVER['REMOTE_ADDR'];
				$record = "$date,$ip,$name,$email\n";
